...
# Create a PNG graphics file of the histogram of the frequency for the global active power variable.
# Use the default width/ height of 480 x 480 pixels. Shut down the PNG device when finished.

png("./data/plot1.png")
hist(dataset$Global_active_power, freq = TRUE, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylab = "Frequency")
dev.off()